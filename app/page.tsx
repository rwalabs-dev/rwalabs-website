...
export default function Home() {
    return (
        <main className="container max-w-[618px] mx-auto flex flex-col gap-8 mt-0 mb-20 lg:mt-20">
            <div className="relative w-full h-[220px]">
                <Image src="/logo.svg" alt="rwalabs" fill priority style={{ objectFit: "contain" }} />
            </div>
            <p className="text-center px-10">
                At RWA-Labs, we are on a mission to revolutionize the world of crypto by bridging the gap between traditional finance and DeFi.
